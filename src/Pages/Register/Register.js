...
const Register = () => {
  ...
  return (
    <section className="bg-white dark:bg-gray-900 md:my-20">
      <div className="container flex items-center justify-center my-14 md:my-0 md:min-h-screen px-6 mx-auto">
        <form
          className="w-full max-w-md p-5 shadow-2xl rounded-lg"
        ...
        >
          ...
          <div className="mt-4">
            <label className="label cursor-pointer justify-start">
              <input
                type="checkbox"
                className="checkbox border-2 border-blue-400"
                {...register("seller")}
              />
